...
public class Constants {
    ...
    public static final String RESTAURANT_LINK = "/public-api/v1/places/?categories=cafe,restaurants&fields=id,title,slug,adress,timetable,images,phone,body_text,site_url,foreign_url,coords,subway,is_closed,address&expand=images";
    ...
    public static final String SHOPS_LINK = "/public-api/v1/places/?categories=shops&fields=id,title,slug,adress,timetable,images,phone,body_text,site_url,foreign_url,coords,subway,is_closed,address&expand=images";
