...
public class Constants {
    ...
    public static final String RESTAURANT_LINK = "/public-api/v1/places/?categories=cafe,restaurants,anticafe,banquets,canteens,coffee,fastfood,roof,vegetarian" + EXTRA_FIELDS;
    public static final long DRAWER_ANIMATION_DURATION = 400L;
    public static final String MUSEUMS_LINK = "/public-api/v1/places/?categories=museums" + EXTRA_FIELDS;
    public static final String CLUBS_LINK = "/public-api/v1/places/?categories=clubs" + EXTRA_FIELDS;
    public static final String BARS_LINK = "/public-api/v1/places/?categories=bar" + EXTRA_FIELDS;
    public static final String ATTRACTIONS_LINK = "/public-api/v1/places/?categories=attract" + EXTRA_FIELDS;
    public static final String RECREATIONS_LINK = "/public-api/v1/places/?categories=climbing-walls,diving,fitness,ice-rink,karts,kempingi,paintball,rollerdromes,slope,sport-centers,stable,swimming-pool,water-park,wind-tunnels" + EXTRA_FIELDS;
    public static final String SHOPS_LINK = "/public-api/v1/places/?categories=shops,books,clothing,confectioneries,farmer-shops,flea-market,gifts,handmade,health-food,online-shopping,perfume-stores,shopping-mall,tea,toys" + EXTRA_FIELDS;
    public static final String HOTELS_LINK = "/public-api/v1/places/?categories=hostels,hotels,inn" + EXTRA_FIELDS;
