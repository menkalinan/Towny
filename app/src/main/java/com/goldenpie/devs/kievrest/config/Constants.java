...
public class Constants {
    ...
    public static final String ATTRACTIONS_LINK = "/public-api/v1/places/?location=kev&categories=attractions&fields=id,title,slug,adress,timetable,images,phone,body_text,site_url,foreign_url,coords,subway,is_closed,address&expand=images";
